...
set(THRIFT_PACKAGE_VENDOR_VERSION "" cache string "vendor specific package version")
if (NOT THRIFT_PACKAGE_VENDOR_VERSION_SUFFIX STREQUAL "")
	set(THRIFT_PACKAGE_VENDOR_VERSION_SUFFIX "-${THRIFT_PACKAGE_VENDOR_VERSION_SUFFIX}")
endif()

### general settings
set(CPACK_PACKAGE_NAME "thrift")
set(CPACK_PACKAGE_VERSION "${PACKAGE_VERSION}${THRIFT_PACKAGE_VENDOR_VERSION_SUFFIX}")
